...
/**
 * This is the item provider adapter for a {@link sistema_emprestimo.Professor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfessorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Professor_nome_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Professor_nome_feature", "_UI_Professor_type"),
				 Sistema_emprestimoPackage.Literals.PROFESSOR__NOME,
				 true,
				 false,
				 false,
	...
	protected void addMatriculaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Professor_matricula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Professor_matricula_feature", "_UI_Professor_type"),
				 Sistema_emprestimoPackage.Literals.PROFESSOR__MATRICULA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDepartamentoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Professor_departamento_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Professor_departamento_feature", "_UI_Professor_type"),
				 Sistema_emprestimoPackage.Literals.PROFESSOR__DEPARTAMENTO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Professor)object).getNome();
